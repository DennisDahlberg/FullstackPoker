      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="#how-to-play" className="text-gray-300 hover:text-amber-400 transition-colors">How to Play</a>
            <a href="#ai-opponents" className="text-gray-300 hover:text-amber-400 transition-colors">AI Opponents</a>
          </div>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-gray-900/95 backdrop-blur-md border-t border-yellow-900/50">
          <div className="px-4 py-6 space-y-4">
            <a href="#features" className="block text-gray-300 hover:text-amber-400 transition-colors">Features</a>
            <a href="#how-to-play" className="block text-gray-300 hover:text-amber-400 transition-colors">How to Play</a>
            <a href="#ai-opponents" className="block text-gray-300 hover:text-amber-400 transition-colors">AI Opponents</a>
            <div className="pt-4 space-y-3">
              <Link to="/login">
                <Button variant="outline" className="w-full border-amber-500 text-amber-400">Sign In</Button>
              </Link>
              <Button className="w-full bg-yellow-600 mt-3">
